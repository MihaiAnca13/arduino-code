...
#line 1 "D:/Google Drive/Disertation/arduino/untitled/untitled.inob"
#include <Arduino.h>
#include <stdlib.h>
#include <string.h>
...
#define RX_PIN 10
#define TX_PIN 11
#line 16 "D:/Google Drive/Disertation/arduino/untitled/cmake-build-debug/untitled_untitled.inob.cpp"
#include "Arduino.h"
...
//=== START Forward: D:/Google Drive/Disertation/arduino/untitled/untitled.inob
 void serialISR() ;
 void serialISR() ;
 void rc_read_values() ;
 void rc_read_values() ;
 ...
 void loop() ;
 void loop() ;
//=== END Forward: D:/Google Drive/Disertation/arduino/untitled/untitled.inob
#line 11 "D:/Google Drive/Disertation/arduino/untitled/untitled.inob"
...
void loop() {
    ...
    if (batteryLevel <= MIN_BAT_LEVEL) {
        ...
        if (nSerial.available()) {
            message = nSerial.read();
            Serial.println(message);
            if (strcmp(message.c_str(), "readings?") == 0) {
                rc_read_values();
                Serial.print("Direction:"); Serial.print(rc_values[RC_CH1]); Serial.print("\t");
                Serial.print("Speed:"); Serial.println(rc_values[RC_CH2]);
...
//=== START : D:/Google Drive/Disertation/arduino/untitled/test.ino
...
//=== END : D:/Google Drive/Disertation/arduino/untitled/test.ino
