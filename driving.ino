...
#define MIN_SPEED 1506
#define MIN_LEFT 1100
#define MAX_RIGHT 1900
...
void setup() {
    ...
    esc_m.writeMicroseconds(esc);
    servo_m.writeMicroseconds(servo);
}
